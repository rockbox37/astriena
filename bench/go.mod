module github.com/rockbox37/astriena/bench

go 1.26.0

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor v0.160.0
	github.com/rockbox37/astriena/components/astrienasampler v0.0.0
...
require (
	...
	github.com/rockbox37/astriena v0.0.0 // indirect
...
replace github.com/rockbox37/astriena => ../

replace github.com/rockbox37/astriena/components/astrienasampler => ../components/astrienasampler
